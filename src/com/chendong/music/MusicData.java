...
public class MusicData implements Parcelable{
	...
	public int getmMusicTime() {
		return mMusicTime;
	}

	public void setmMusicTime(int mMusicTime) {
	...
	public String getmMusicAritst() {
		return mMusicAritst;
	}

	public void setmMusicAritst(String mMusicAritst) {
		this.mMusicAritst = mMusicAritst;
	}
